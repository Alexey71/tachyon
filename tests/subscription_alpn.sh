...
assert_contains "$clash_output" '"tag": "clash-http"' "clash-http"
assert_contains "$clash_output" '"type": "http"' "clash-http"
assert_not_contains "$clash_output" '"tag": "clash-unsupported"' "clash-unsupported"
assert_contains "$clash_output" '"skipped": 1' "clash-unsupported"
