...
const REDIRECT_INBOUND_TAG = "redirect-in";
const REDIRECT_INBOUND_ADDRESS = "127.0.0.1";
const REDIRECT_INBOUND_PORT = 1604;
...
return {
    ...
    REDIRECT_INBOUND_TAG,
    REDIRECT_INBOUND_ADDRESS,
    REDIRECT_INBOUND_PORT,
